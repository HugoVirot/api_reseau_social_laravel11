<template>
  <div v-if="content !== ''">
    <div class="pt-2 text-center">
      ...
      <h2 class="mt-2 fs-1">Modifier un commentaire</h2>
    </div>
...
onBeforeMount(() => {
  axios
    .get("http://localhost:8000/api/comments/" + commentId)

    .then((response) => {
      console.log(response.data);
      content.value = response.data.comment.content;
      tags.value = response.data.comment.tags;
      image.value = response.data.comment.image;
    })
